package org.vs.data.structures.sort;

import org.vs.data.structures.sorting.CommonUtil;

//In this sorting algorithm, we start with first element in array and compare with next element and keep track of index of minimum number.
